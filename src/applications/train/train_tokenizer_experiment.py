...
t_config = TokenizerConfig(
    ...
    byte_level = False)
tokenizer = train_tokenizer(corpus = dataset.take(100_000), config=t_config, save_tokenizer=True, output_dir="ucloud-setup/dfm_tokenizer/unigram")
...
t_config = TokenizerConfig(
    ...
    add_prefix_space = True,
    byte_level = False)
tokenizer = train_tokenizer(corpus = dataset.take(100_000), config=t_config, save_tokenizer=True, output_dir="ucloud-setup/dfm_tokenizer/unigram_128000_tokens")
msg.good("Finished unigram training tokenizer")
...
t_config = TokenizerConfig(
    ...
    add_prefix_space = True,
    byte_level = False)
tokenizer = train_tokenizer(corpus = dataset.take(100_000), config=t_config, save_tokenizer=True, output_dir="ucloud-setup/dfm_tokenizer/unigram_32000_tokens")
msg.good("Finished unigram training tokenizer")
